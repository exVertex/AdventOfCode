...
2. Open a terminal and run `dotent run` at root.
    ...
    - <strong>Note:</strong> Puzzle inputs are example inputs from day page. Actual puzzle input must be pasted manually to the correct .txt file (ex. paste your puzzleInput for day 1, year 2022 to file `./Y2022/PuzzleInputs/day01.txt`).
